...
import { NzCardModule, NzLayoutModule, NzMenuModule, NzToolTipModule } from 'ng-zorro-antd';
...
const ANTD_MODULES = [NzIconModule.forRoot(icons), NzToolTipModule, NzMenuModule, NzLayoutModule, NzCardModule];
